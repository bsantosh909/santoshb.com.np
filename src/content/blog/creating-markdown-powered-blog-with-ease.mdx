...
created: 2020-05-31
summary: >
  How to create a blog with markdown? How to use markdown to create a blog? If those are the question you have then with the awesome tools like Nuxt.js, nuxt-content and the awesome Jamstack concept the task gets easy like never before!
tags:
  - Jamstack
  - Markdown
  - Nuxt
...
- [**This site**](https://github.com/bsantosh909/santoshb.com.np) is a live example and demo of using this article! _Lots of changes will be made to the site and article itself to show what more you can do with it!_
