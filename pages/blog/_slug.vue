<template>
  <div class="container mx-auto px-4 py-6 md:px-8">
    <div align="center">
      <p class="font-bold text-3xl md:text-5xl mt-4 mb-2">
        {{ article.title }}
      </p>
      <p class="text-xl">{{ article.subtitle }}</p>
    </div>
    <div
      class="border-t border-b border-dark-700 py-1 flex flex-wrap justify-between my-8 text-sm"
    >
      <div class="flex flex-wrap space-x-6">
        <div class="flex space-x-1">
          ...
          <span class="font-semibold">{{
            getDate(article.updated ? article.updated : article.created)
          }}</span>
        </div>
        <div class="flex space-x-1">
          <div>
    ...
    <div class="mb-6 text-center">
      <span class="font-bold text-lg">
        I hope you liked the article. Make sure to leave your feedbacks or
        queries through the comments below!
      </span>
    </div>
    <div
      class="border-t border-b border-dark-700 py-1 flex flex-wrap justify-between"
    >
...
.nuxt-content h2 {
  ...
  & > a {
    ...
    &::before {
      content: "#";
      @apply font-semibold -ml-6 pr-1 absolute opacity-100;
    }
  }
  &:hover {
    & > a::before {
...
.nuxt-content h3 {
  ...
  & > a {
    ...
    &::before {
      content: "#";
      @apply font-semibold -ml-5 pr-1 absolute opacity-100;
    }
  }
  &:hover {
    & > a::before {
