<template>
  <div class="container mx-auto py-2 md:py-8 md:px-2 text-center">
    <!-- 	  
    <div align="right">
      <input
        class="shadow-md border rounded w-64 mb-6 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
    ...
    <div class="mb-16">
      <span>
        ...
        mistakes and possibilities) for various stuffs! I hope these article
        will be helpful to you, or maybe you can learn something new after
        reading these out.
      </span>
      <br />
      <span class="font-semibold italic">
        Make sure to read them and share your feedbacks with me in the comment
        sections.
      </span>
    </div>
    <div
