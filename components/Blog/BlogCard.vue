<template>
  <div
    class="flex justify-center shadow-lg bg-gray-100 border border-gray-300 rounded-md mx-2 md:mx-4 select-none"
  >
    <div class="block mr-auto">
      ...
      <div class="px-4 md:px-8 py-2">
        ...
        <div
          class="py-1 flex flex-wrap justify-between border-t border-b border-dark-700 mt-5 text-sm"
        >
...
export default {
  ...
  methods: {
    getDate(date) {
      return new Timestamp("MMM d, YYYY").display(date);
    },
  },
};
</script>
