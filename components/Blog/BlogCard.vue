<template>
	<div
		class="flex justify-center shadow hover:shadow-lg bg-gray-100 border border-gray-300 rounded-md mx-4 select-none"
	>
		<div class="block mr-auto">
			...
			<div class="px-8 py-2">
				...
				<div
					class="py-1 flex flex-wrap justify-between border-t border-b border-dark-700 py-1 mt-3 text-sm"
				>
